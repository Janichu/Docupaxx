...
router.use(function timeLog(req, res, next) {
 ...
 // Get a SentDocument of a SentPackage (& iUser) (Note: doesn't really need packageId)
router.get("/users/:userId/sentdocument/:sentPackageId/:sentDocumentId", async (req,res)=>{
 ...
 // Get all SentDocuments of a SentPackage (& iUser)
router.get("/users/:userId/sentdocument/:sentPackageId", async(req,res)=>{
